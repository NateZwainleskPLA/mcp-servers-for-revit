...
function parsePort(): number {
  ...
  console.error(
    "WARNING: No --revit-version or --port specified. Falling back to port 8080, " +
    "which likely won't match the plugin's version-derived port. " +
    "Use: --revit-version <year> (e.g. --revit-version 2025)"
  );
  return 8080;
}
